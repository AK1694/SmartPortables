...
public class ProductCrud extends HttpServlet {
	protected void doGet(HttpServletRequest request,
			...
			{
			  			if(producttype.equals("wearabletechnology")){
				  allwearables = MySqlDataStoreUtilities.getWearables();
				  if(allwearables.containsKey(productId)){
			  ...
			  }else if (producttype.equals("smartspeakers"))
			  {
				  allsmartspeakers = MySqlDataStoreUtilities.getSmartSpeakers();
				  if(allsmartspeakers.containsKey(productId)){
					  msg = "Product already available";
				  }
			  }
					...
					if(!request.getParameter("product").isEmpty())
						{
							...
							allwearables = MySqlDataStoreUtilities.getWearables();
							if(allwearables.containsKey(prod))
							{
