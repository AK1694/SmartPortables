	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='wearables' selected>WearableTechnology</option><option value='phones'>Phones</option><option value='laptops'>Laptops</option><option value='smartspeakers'>SmartSpeakers</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
