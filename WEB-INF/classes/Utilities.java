...
public class Utilities extends HttpServlet{
	...
	public void storeProduct(String name,String type,String maker, String acc){
		...
		if(type.equals("wearables")){
			...
			wearable = allwearables.get(name);
		...
		if(type.equals("smartspeakers")){
			...
			smartspeaker = allsmartspeakers.get(name);
	...
	public HashMap<String, WearableTechnology> getWearables(){
	...
	/* getProducts Functions returns thin the store.*/

	public ArrayList<String> getProductsWearables(){
		ArrayList<String> ar = new ArrayList<String>();
		for(Map.Entry<String, WearableTechnology> entry : getWearables().entrySet()){			
			ar.add(entry.getValue().getName());
		}
		return ar;
	}
	
	/* getProducts Functions returns then the store.*/
	...
	/* getProducts Functions returns in the store.*/
	...
	public HashMap<String,String> readOutputFile(){
		String csvFile = "C:/apache-tomcat-7.0.34/webapps/SmartPortablesHW44/output.csv";
