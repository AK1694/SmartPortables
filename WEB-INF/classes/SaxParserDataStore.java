...
public class SaxParserDataStore extends DefaultHandler {
    ...
    Accessory accessory;
    static HashMap<String,WearableTechnology> wearables;
    ...
    wearables = new HashMap<String, WearableTechnology>();
...
////////////////////////////////////////////////////////////
    ...
    public void startElement(String str1, String str2, String elementName, Attributes attributes) throws SAXException {
        ...
        if (elementName.equalsIgnoreCase("wearable")) 
		{
			...
			wearable = new WearableTechnology();
...
//call the constructor to parse the xml and get product details
		...
		new SaxParserDataStore(TOMCAT_HOME+"\\webapps\\SmartPortablesHW44\\ProductCatalog.xml");
    } 
