...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<img src='images/home/a5.jpg'style='width: 600px; display: block; margin-left: auto; margin-right: auto' />");
		pw.print("<br> <br>");
		pw.print("<h2>The best you can get is here </h2>");
		pw.print("<br> <br>");
		pw.print("<h1>We beat our competitors in all aspects. Price-Match Guaranteed</h2>");
			...
			BufferedReader reader = new BufferedReader(new FileReader (new File(TOMCAT_HOME+"\\webapps\\SmartPortablesHW44\\DealMatches.txt")));
...
//		
			...
			pw.print("<h2 align='center'>No Offers Found in Exception</h2>");
			}
		pw.print("</div>");
		pw.print("</div>");
		pw.print("<div class='post'>");
